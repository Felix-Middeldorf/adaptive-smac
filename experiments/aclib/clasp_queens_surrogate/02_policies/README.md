# Clasp Queens deterministic adaptive-depth policies

This folder runs six RF-depth policies for 5,000 trials and SMAC seeds 0, 1,
and 2. All 484 training instances are used; test instances are excluded.
...
`01_initial_cq/analytics_cache/incumbent_trajectory_events.csv`, using
