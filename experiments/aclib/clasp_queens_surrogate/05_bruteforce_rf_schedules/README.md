# Clasp Queens brute-force RF schedules
...
probability 0%, 5,000 trials, all 484 training instances, deterministic target
quantile seed 0, the initial configuration from `01_initial_cq`, local SMAC,
`PYTHONHASHSEED=0`, Slurm account `lect0190`, 16 hours, and 4 GB.
