# Clasp Queens random sample

This experiment draws 1,000 unique configurations from the official Clasp
Queens ConfigSpace using seed `20260729`. Each configuration is evaluated on
all 484 training instances with the deterministic EPM median (quantile seed
zero) and five reproducible stochastic EPM quantile draws.
