...
The downloaded input is `external/aclib-performance-data/cplex_rcw`, from the
...
Agreement with the 10,000 archived points is strong: Spearman 0.967, 93.5% of
predictions within a factor of two, and timeout recall 80.5%. This check
supports using the installed CPLEX RCW surrogate.
