...
# Resolve shared modules relative to this file instead of requiring callers to
# configure PYTHONPATH or use a wrapper script.
...
def submit_jobs() -> None:
    ...
    executor.update_parameters(
        ...
        cpus_per_task=1,
        mem_gb=MEM_GB,
        slurm_job_name="ACLib_CPLEX_R200_fixed_depths",
        slurm_setup=[
    ...
    for job_spec, job in submitted:
        print(
            f"depth={job_spec.depth}, smac_seed={job_spec.smac_seed}: {job.job_id}"
        )
