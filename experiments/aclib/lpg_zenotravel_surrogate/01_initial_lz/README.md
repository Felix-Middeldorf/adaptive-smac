# LPG Zenotravel: initial fixed-depth experiment
...
- all 2,000 training instances and no test instances
- Slurm account `lect0190` and worker `PYTHONHASHSEED=0`

The ACLib default ranked third in a 129-configuration screen, so the run starts
