# LPG Zenotravel deterministic adaptive-depth policies

This folder runs six RF-depth policies for 5,000 trials and SMAC seeds 0, 1,
and 2. All 2,000 training instances are used; test instances are excluded.
...
depths in `01_initial_lz/analytics_cache/incumbent_trajectory_events.csv`,
