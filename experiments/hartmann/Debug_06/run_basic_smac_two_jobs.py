...
RUN_LABELS = ["basic_run_a", "basic_run_b"]
SEED = 0
N_TRIALS = 400
N_INITIAL_DESIGN_CONFIGS = 25
SLURM_PARTITION = "c23ms"

OUTPUT_DIRECTORY = Path(__file__).resolve().parent / "basic_smac_two_jobs"
LOG_DIRECTORY = Path(__file__).resolve().parent / "logs_basic_smac_two_jobs"
...
def submit_jobs() -> None:
    ...
    executor.update_parameters(
        ...
        cpus_per_task=1,
        mem_gb=2.4,
        slurm_job_name="HartmannDebug06Basic",
