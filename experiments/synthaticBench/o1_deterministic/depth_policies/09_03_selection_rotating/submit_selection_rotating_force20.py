...
TIMEOUT_MIN = 720
MEM_GB = 4
LOG_DIRECTORY = HERE / "submitit_logs_force20"


def print_experiment_summary() -> None:
    jobs = len(SMAC_SEEDS)
    runs = jobs * len(BENCHMARK_SEEDS)
    print("Experiment: O1 rotating depth selection with forced final depth 20")
...
def submit_jobs() -> None:
    ...
    executor.update_parameters(
        ...
        cpus_per_task=1,
        mem_gb=MEM_GB,
        slurm_job_name="SynthACtic_O1_SelectionRotateForce20",
        slurm_setup=[
