...
TIMEOUT_MIN = 720
MEM_GB = 4
LOG_DIRECTORY = HERE / "submitit_logs_additional"
...
def print_experiment_summary() -> None:
    ...
    print(f"Additional instance standard deviations: {ADDITIONAL_INSTANCE_STDS}")
...
def submit_jobs() -> None:
    ...
    executor.update_parameters(
        ...
        cpus_per_task=1,
        mem_gb=MEM_GB,
        slurm_job_name="SynthACtic_O1_InstanceValues_Extra_RD0",
        slurm_setup=[
    ...
    jobs = []
    with executor.batch():
        for instance_std in ADDITIONAL_INSTANCE_STDS:
