...
"""Submit one default-SMAC run for each of five SMAC seeds."""
...
from o1_enumerated_instance_features_runner import (
    BENCHMARK_SEED,
    DIMENSION,
    HERE,
    N_INSTANCES,
...
def print_summary(*, list_jobs: bool = False) -> None:
    ...
    print("Instance features: integer enumeration [0], [1], ..., [9]")
...
def submit_jobs() -> None:
    ...
    executor.update_parameters(
        ...
        cpus_per_task=1,
        mem_gb=MEM_GB,
        slurm_job_name="O1_enum_instance_features",
        slurm_setup=[
